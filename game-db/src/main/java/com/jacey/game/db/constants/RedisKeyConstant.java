...
public class RedisKeyConstant {
	...
	// 进行中的battleId与聊天服务器的绑定关系（map类型，key:battleId, value:battleServerId）
	public static final String BATTLE_ID_TO_CHAT_SERVER_ID = "battleIdToChatServerId";
	...
	public static final String CHAT_SERVER_LOAD_BALANCE = "chatServerLoadBalance";
	...
	public static final String CHAT_SERVER_ID_TO_AKKA_PATH = "chatServerIdToAkkaPath";
