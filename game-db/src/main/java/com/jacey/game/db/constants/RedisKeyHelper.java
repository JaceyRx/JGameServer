...
public class RedisKeyHelper {
	...
	public static String getBattleIdToChatServerIdRedisKey() {
		return RedisKeyConstant.BATTLE_ID_TO_CHAT_SERVER_ID;
	}
	...
	/** chatServer 负载key */
	public static String getChatServerLoadBalanceRedisKey() {
		return RedisKeyConstant.CHAT_SERVER_LOAD_BALANCE;
	}
	...
	public static String getChatServerIdToAkkaPathRedisKey() {
		return RedisKeyConstant.CHAT_SERVER_ID_TO_AKKA_PATH;
	}
