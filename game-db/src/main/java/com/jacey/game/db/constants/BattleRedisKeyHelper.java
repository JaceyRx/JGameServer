...
public class BattleRedisKeyHelper {
	...
	public static String getBattlePlayingBattleIdsRedisKey(CommonEnum.BattleTypeEnum battleType) {
	...
	public static String getBattleRecordListRedisKey(CommonEnum.BattleTypeEnum battleType, long oneDayZeroClockTimestamp) {
